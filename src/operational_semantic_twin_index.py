"""Operational-Semantic Twin Index — SCAFFOLD STUB.

Company lens: MongoDB (independent; no affiliation).
Bottleneck: integrating AI retrieval/memory without turning a general operational database into an overcomplex bundle or duplicating state across systems
...
class OperationalSemanticTwinIndex:
    ...
    - `evaluate(req)` returns a OperationalSemanticTwinIndexReceipt
    ...
    def evaluate(self, req: OperationalSemanticTwinIndexRequest) -> OperationalSemanticTwinIndexReceipt:
        ...
        if reasons:
            ...
            return OperationalSemanticTwinIndexReceipt(
