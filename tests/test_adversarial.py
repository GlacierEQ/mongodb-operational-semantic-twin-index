...
class AdversarialEliteTests(unittest.TestCase):
    def _load(self):
        errors = []
        for name in ('operational_semantic_twin_index', "src." + 'operational_semantic_twin_index'):
            try:
    ...
    def test_refuse_bad_import_path_does_not_shadow(self):
        with self.assertRaises(ModuleNotFoundError):
            importlib.import_module("src.__elite_does_not_exist_" + 'operational_semantic_twin_index')
